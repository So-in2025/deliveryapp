    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-sm rounded-2xl shadow-2xl overflow-hidden relative animate-slide-up z-10">
        ...
        <div className="bg-slate-900 p-6 text-white text-center relative">
            ...
            <p className="text-slate-300 text-xs mt-1 relative z-10">Versión Beta 1.0</p>
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="space-y-4">
                <div className="flex gap-3 items-start">
                    <div className="w-8 h-8 rounded-full bg-brand-100 text-brand-600 flex items-center justify-center shrink-0 font-bold text-sm">1</div>
                    <div>
                        <h4 className="font-bold text-slate-900 text-sm flex items-center gap-2"><ShoppingBag size={14}/> Cliente</h4>
                        <p className="text-xs text-slate-500">Haz un pedido en "Burger & Co".</p>
                    </div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                    ...
                    <div>
                        <h4 className="font-bold text-slate-900 text-sm flex items-center gap-2"><LayoutDashboard size={14}/> Comercio</h4>
                        <p className="text-xs text-slate-500">Acepta el pedido y márcalo como "Listo".</p>
                    </div>
                </div>
                ...
                <div className="flex gap-3 items-start">
                    <div className="w-8 h-8 rounded-full bg-amber-100 text-amber-600 flex items-center justify-center shrink-0 font-bold text-sm">3</div>
                    <div>
                        <h4 className="font-bold text-slate-900 text-sm flex items-center gap-2"><Truck size={14}/> Driver</h4>
                        <p className="text-xs text-slate-500">Acepta el envío y entrégalo.</p>
                    </div>
                </div>
            </div>
